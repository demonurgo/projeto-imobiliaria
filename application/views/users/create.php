        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0"><i class="fas fa-user-plus"></i> Novo Usuário</h5>
                </div>
                <div class="card-body">
                    <?php echo form_open('users/create'); ?>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">Usado para login no sistema. Não pode ser alterado posteriormente.</small>
                            </div>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_admin" name="is_admin" value="1" <?php echo set_checkbox('is_admin', '1'); ?>>
