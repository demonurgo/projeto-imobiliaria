        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0"><i class="fas fa-user-edit"></i> Editar Inquilino</h5>
                </div>
                <div class="card-body">
                    ...
                    <?php echo form_open('inquilinos/edit/'.$inquilino['id'], ['class' => 'needs-validation', 'novalidate' => '']); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="nome" name="nome" value="<?= set_value('nome', $inquilino['nome']) ?>" required>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tipo_documento" name="tipo_documento" required>
                                    <option value="cpf" <?= set_select('tipo_documento', 'cpf', ($tipo_documento == 'cpf')) ?>>CPF</option>
                                    <option value="cnpj" <?= set_select('tipo_documento', 'cnpj', ($tipo_documento == 'cnpj')) ?>>CNPJ</option>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="documento" name="documento" value="<?= set_value('documento', $documento) ?>" required>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="telefone" name="telefone" value="<?= set_value('telefone', $inquilino['telefone']) ?>">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value="<?= set_value('email', $inquilino['email']) ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="endereco" name="endereco" rows="2"><?= set_value('endereco', $inquilino['endereco']) ?></textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="observacoes" name="observacoes" rows="3"><?= set_value('observacoes', $inquilino['observacoes']) ?></textarea>
                            </div>
                        </div>
                    </div>
