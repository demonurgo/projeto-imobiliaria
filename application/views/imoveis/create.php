        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0"><i class="fas fa-plus-circle"></i> Cadastrar Novo Imóvel</h5>
                </div>
                <div class="card-body">
                    ...
                    <?php echo form_open('imoveis/create', ['class' => 'needs-validation', 'novalidate' => '']); ?>
                    
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="codigo_referencia" class="form-label">Código de Referência</label>
                                <input type="text" class="form-control" id="codigo_referencia" name="codigo_referencia" value="<?= set_value('codigo_referencia') ?>">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tomador_id" name="tomador_id">
                                    ...
                                    <option value="<?= $tomador['id'] ?>" <?= set_select('tomador_id', $tomador['id']) ?>>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="inquilino_id" name="inquilino_id">
                                    ...
                                    <option value="<?= $inquilino['id'] ?>" <?= set_select('inquilino_id', $inquilino['id']) ?>>
                                        <?= $inquilino['nome'] ?>
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="valor_aluguel" name="valor_aluguel" value="<?= set_value('valor_aluguel') ?>" step="0.01" min="0">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="tipo_imovel" name="tipo_imovel">
                                    <option value="urbano" <?= set_select('tipo_imovel', 'urbano', true) ?>>Urbano</option>
                                    <option value="rural" <?= set_select('tipo_imovel', 'rural') ?>>Rural</option>
                                </select>
                            </div>
                        </div>
                    </div>
