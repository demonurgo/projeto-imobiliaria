                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="imovel_cidade" name="imovel_cidade" 
                                                    value="<?= isset($nota['imovel_cidade']) ? $nota['imovel_cidade'] : 
                                                        (isset($nota['imovel_id']) && !empty($nota['imovel_id']) ? 
                                                        $this->Imovel_model->get_by_id($nota['imovel_id'])['cidade'] : '') ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="imovel_uf" name="imovel_uf" maxlength="2" 
                                                    value="<?= isset($nota['imovel_uf']) ? $nota['imovel_uf'] : 
                                                        (isset($nota['imovel_id']) && !empty($nota['imovel_id']) ? 
                                                        $this->Imovel_model->get_by_id($nota['imovel_id'])['uf'] : '') ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="imovel_cep" name="imovel_cep" 
                                                    value="<?= isset($nota['imovel_cep']) ? $nota['imovel_cep'] : 
                                                        (isset($nota['imovel_id']) && !empty($nota['imovel_id']) ? 
                                                        $this->Imovel_model->get_by_id($nota['imovel_id'])['cep'] : '') ?>">
                                            </div>
                                        </div>
